...
# ================================================================================
# For code that still uses the old ImprovedToolSelector from v1.0

# Alias the new classes to old names for backward compatibility
ImprovedToolSelector = EnhancedToolSelector
ToolIntent = ParsedIntent  # Map old ToolIntent to ParsedIntent
ToolSelectionResult = SelectionResult  # Map old result type
...
__all__ = [
    ...
    'normalize_verb',
    # Backward Compatibility (v1.0 aliases)
    'ImprovedToolSelector',  # -> EnhancedToolSelector
    'ToolIntent',  # -> ParsedIntent
    'ToolSelectionResult',  # -> SelectionResult
    'integrate_with_existing_system',  # -> integrate_enhanced_selector
    # Utilities
    'fuzzy_match',
